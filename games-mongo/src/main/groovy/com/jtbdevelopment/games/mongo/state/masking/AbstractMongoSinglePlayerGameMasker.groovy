 ...
 * Time: 6:49 PM
 */
abstract class AbstractMongoSinglePlayerGameMasker<FEATURES, U extends AbstractMongoSinglePlayerGame<FEATURES>, M extends MaskedSinglePlayerGame<FEATURES>> extends AbstractSinglePlayerGameMasker<ObjectId, FEATURES, U, M> {
    @Override
    Class getIDClass() {
