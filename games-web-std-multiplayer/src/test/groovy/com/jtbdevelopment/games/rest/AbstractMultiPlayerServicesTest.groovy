 ...
 * Time: 10:28 PM
 */
class AbstractMultiPlayerServicesTest extends GameCoreTestCase {
    AbstractMultiPlayerServices services = new AbstractMultiPlayerServices() {}
    ...
    void testGamesAnnotations() {
        def gameServices = AbstractMultiPlayerServices.getMethod("gamesForPlayer", [] as Class[])
