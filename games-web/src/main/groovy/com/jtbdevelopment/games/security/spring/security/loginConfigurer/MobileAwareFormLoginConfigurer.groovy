 ...
 * Time: 2:44 PM
 *
 * Cut-n-paste of spring security class of same name to provide for overriding behaviour in AbstractAuthenticationFilterConfigurer
 */

class MobileAwareFormLoginConfigurer extends
//  JTB simplified template params for groovy
    ...
    public MobileAwareFormLoginConfigurer loginPage(String loginPage) {
        return (MobileAwareFormLoginConfigurer) super.loginPage(loginPage);
    }
