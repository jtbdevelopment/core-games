...
/**
 * Based on spring social facebook FacebookServiceProvider - only change is to swap out Oauth2Template
 */
@CompileStatic
class CustomFacebookServiceProvider extends AbstractOAuth2ServiceProvider<Facebook> {
