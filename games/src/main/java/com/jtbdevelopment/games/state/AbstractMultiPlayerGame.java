 ...
 * Time: 5:30 PM
 */
public abstract class AbstractMultiPlayerGame<ID extends Serializable, FEATURES> extends AbstractGame<ID, FEATURES> implements MultiPlayerGame<ID, Instant, FEATURES> {
